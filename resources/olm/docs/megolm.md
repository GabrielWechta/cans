...
The length of the signature is determined by the signing algorithm being used (64 bytes
...
To mitigate this issue, the application should offer the user the option to discard
