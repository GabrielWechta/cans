...
class Session(object):
    ...
    def matches(self, message, identity_key=None):
        ...
        if identity_key:
            ...
            ret = lib.olm_matches_inbound_session(
                self._session, message_buffer, len(byte_ciphertext)
            )
    ...
    def describe(self, buffer_length=600):
        ...
        lib.olm_session_describe(self._session, describe_buffer, buffer_length)
