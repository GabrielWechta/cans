...
Aside from everything mentioned so far doctest has some
...
**doctest** doesn't support mocking but should be easy to integrate with third-party
libraries such as:
...
A compiler-specific solution for MSVC is to use the
