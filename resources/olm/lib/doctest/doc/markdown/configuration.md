...
If the client wants to [**supply the `main()` function**](main.md) (either to set an
...
The `REQUIRE` family of asserts uses exceptions to terminate the current test case when
